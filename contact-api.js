...
// Email configuration
const smtpUser = process.env.SMTP_USER || process.env.EMAIL_USER || 'sales@hmz.technology';
...
app.post('/api/contact', async (req, res) => {
  try {
    ...
    const adminEmail = process.env.ADMIN_EMAIL || smtpUser || 'sales@hmz.technology';
